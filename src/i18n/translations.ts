  ...
  ro: {
    ...
    overview: {
      ...
      metrics: {
        ...
        live: "Live",
        paused: "Pauză",
        jvmMemory: "Memorie aplicație",
        systemRam: "RAM sistem",
        cpuUsage: "Utilizare CPU",
        diskUsage: "Stocare",
        load: "Load",
        process: "Proces",
        historyHeap: "Istoric memorie aplicație",
    ...
    profile: {
      ...
      passwordUpdateError: "Nu am putut actualiza parola.",
      passwordMismatch: "Parolele nu coincid.",
      currentPasswordInvalid: "Parola curentă este incorectă.",
      ...
      changePasswordSubtitle: "Actualizează parola contului tău.",
      changePasswordAction: "Schimbă parola",
      labels: {
        email: "Email",
        role: "Rol principal",
        status: "Statut",
    ...
    teacher: {
      ...
      sidebarToggle: "Configurare sidebar",
      articleFields: {
        title: "Titlu",
        summary: "Rezumat",
        body: "Conținut",
  ...
  en: {
    ...
    overview: {
      ...
      metrics: {
        ...
        live: "Live",
        paused: "Paused",
        jvmMemory: "App memory",
        systemRam: "System RAM",
        cpuUsage: "CPU usage",
        diskUsage: "Storage",
        load: "Load",
        process: "Process",
        historyHeap: "App memory history",
    ...
    teacher: {
      ...
      sidebarToggle: "Sidebar configuration",
